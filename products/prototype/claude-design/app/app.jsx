...
const ILLUST_LIB = [
  // 一日 (daily routine)
  { id: 'wakeup',    cat: '一日',     label: 'おきる',         src: REAL('おきる.png') },
  { id: 'dress',     cat: '一日',     label: 'きがえる',       src: REAL('きがえ.png') },
  { id: 'hamigaki',  cat: '一日',     label: 'はをみがく',     src: REAL('はみがき.png') },
  { id: 'toilet',    cat: '一日',     label: 'トイレ',         src: REAL('トイレ.png') },
  { id: 'ofuro',     cat: '一日',     label: 'おふろ',         src: REAL('おふろ.png') },
  { id: 'pajamas',   cat: '一日',     label: 'パジャマ',       src: REAL('パジャマ.png') },
  { id: 'sleep',     cat: '一日',     label: 'おやすみ',       src: REAL('おやすみ.png') },
  { id: 'okatazuke', cat: '一日',     label: 'おかたづけ',     src: REAL('おかたづけ.png') },
  { id: 'mochimono', cat: '一日',     label: 'もちもの',       src: REAL('もちもの.png') },

  // 食事
  { id: 'meal',      cat: '食事',     label: 'ごはん',         src: REAL('ごはん.png') },
  { id: 'taberu',    cat: '食事',     label: 'たべる',         src: REAL('たべる.png') },
  { id: 'gochiso',   cat: '食事',     label: 'ごちそうさま',   src: REAL('ごちそうさま.png') },
  { id: 'snack',     cat: '食事',     label: 'おやつ',         src: REAL('おかしえらぶ.png') },

  // おでかけ
  { id: 'goaisatsu', cat: 'おでかけ', label: 'ごあいさつ',     src: REAL('ごあいさつ.png') },
  { id: 'itte',      cat: 'おでかけ', label: 'いってきます',   src: REAL('いってきます.png') },
  ...
  // おかいもの
  { id: 'shop',      cat: 'おかいもの', label: 'おかいもの',   src: REAL('かいもの.png') },
  { id: 'cart',      cat: 'おかいもの', label: 'カートをおす', src: REAL('カートをおす.png') },
  { id: 'erabu',     cat: 'おかいもの', label: 'えらぶ',       src: REAL('えらぶ.png') },
  { id: 'reji',      cat: 'おかいもの', label: 'レジにならぶ', src: REAL('レジにならぶ.png') },

  // 学校
  { id: 'sensei',    cat: '学校',     label: 'せんせいとおはなし', src: REAL('せんせいとおはなし.jpg') },
  { id: 'shizukani', cat: '学校',     label: 'しずかに',       src: REAL('しずかに.png') },
  { id: 'suwaru',    cat: '学校',     label: 'すわる',         src: REAL('すわる.png') },
  { id: 'narabu',    cat: '学校',     label: 'ならぶ',         src: REAL('ならぶ.png') },
  { id: 'matsu',     cat: '学校',     label: 'まつ',           src: REAL('まつ.png') },
  { id: 'study',     cat: '学校',     label: 'べんきょう',     src: REAL('えほん.png') },
  { id: 'owari',     cat: '学校',     label: 'おわり',         src: REAL('おわり.png') },

  // ごほうび
  { id: 'gohobi',    cat: 'ごほうび', label: 'ごほうび',       src: REAL('ごほうび.png') },
];
